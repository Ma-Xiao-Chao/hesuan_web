<template>
  <div>
    ...
    <div class="container" style="margin-bottom: 10px; text-align: left; margin-top: 10px">
      ...
      <el-button type="primary" icon="el-icon-position" @click="creataCode">生成试管二维码</el-button>
    ...
    <div class="container">
      ...
      <div class="pagination">
        <el-pagination :current-page="currentPage" :page-sizes="[7, 20, 50, 100]" :page-size="7" background layout="total, sizes, prev, pager, next"
