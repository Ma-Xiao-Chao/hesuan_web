<template>
  <div>
    <van-nav-bar left-text="返回" left-arrow title="核酸检测分组扫码" @click-left="onClickLeft" />
    ...
    <van-overlay :show="show" @click="show = false">
      <div class="scaner" ref="scaner">
        ...
        <video id="video" class="source" ref="video" :width="videoWH.width" :height="videoWH.height"></video>
      </div>
    </van-overlay>
  </div>
</template>
