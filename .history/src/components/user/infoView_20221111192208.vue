    ...
    methods: {
      ...
      creatQrCode() {
        new QRCode(this.$refs.qrCodeUrl, {
          ...
          tname: '',
          area: '',
          text: '{"idcardnum":"' + this.userInfo.idcardnum + '","tname":"' + this.userInfo.tname + '","sex":"'+this.userInfo.sex+'","phonenum":"'+this.userInfo.phonenum+'","idcardnum":"'+this.userInfo.idcardnum+'","area":"'+this.userInfo.area+'","address":"'+this.userInfo.address+'"}', // 需要转换为二维码的内容
          width: 180,
          height: 180,
          colorDark: 'green',
          colorLight: '#ffffff',
