<template>
  <div class="main1">
    ...
    <el-row style="margin-top: 40px">
      ...
      <el-col :span="12">
        <div id="main" style="width: 100%; height: 500px">{{111}}</div>
      </el-col>
      ...
      // alert(myChart)
       ...
       // 获取数据
        ...
        this.$axios
          ...
          .then((res) => {
            this.today = res.data.data.chinaTotal.today
            this.extData = res.data.data.chinaTotal.extData
            this.total = res.data.data.chinaTotal.total
            let data = [{ name: '南海诸岛', value: 0 }]
            res.data.data.areaTree[2].children.forEach(item => {
