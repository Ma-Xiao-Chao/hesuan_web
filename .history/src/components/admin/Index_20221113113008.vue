        ...
        <div style="width: 500px; margin: 0 auto; padding: 20px; box-shadow: 0 5px 15px -5px rgba(0,0,0,.5); border-radius: 10px;">
          ...
          <div style="display: flex; flex-wrap:wrap; justify-content: flex-start;">
            <div class="item" style="background-color: lightblue">
              ...
              <div class="item_num" style="color: RoyalBlue">{{}}</div>
            ...
            <div class="item" style="background-color: lightgoldenrodyellow">
              ...
              <div class="item_num" style="color: OrangeRed">{{}}</div>
              <div class="item_num item_num_plus">较昨日 <span style="color: OrangeRed">+{{ }}</span></div>
            </div>
            <div class="item" style="background-color: lightgray">
              <div class="item_title">累计确诊</div>
              <div class="item_num" style="color: Brown">{{  }}</div>
              <div class="item_num item_num_plus">较昨日 <span style="color: Brown">+{{ }}</span></div>
            </div>
            <div class="item" style="background-color: lightpink">
              <div class="item_title">累计死亡</div>
              <div class="item_num" style="color: #333">{{ }}</div>
              <div class="item_num item_num_plus">较昨日 <span style="color: #333">+{{}}</span></div>
            </div>
            <div class="item" style="background-color: lightgreen">
              <div class="item_title">累计治愈</div>
              <div class="item_num" style="color: green">{{}}</div>
              <div class="item_num item_num_plus">较昨日 <span style="color: green">+{{}}</span></div>
            </div>
          </div>
        </div>
      </el-col>
...
<script>
  ...
  // import '@/utils/china.js'from 'echarts'
  ...
  export default {
    ...
    methods: {
      get() {
        ...
        this.$axios
          .get('/echarts/epidemic')
          .then((res) => {
            // console.log(res.data.chinaTotal.today)
            this.role = res.data.chinaTotal.today;
