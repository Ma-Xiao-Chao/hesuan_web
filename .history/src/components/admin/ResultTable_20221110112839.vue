    ...
    <div class="container">
      <div class="handle-box">
        ...
        <el-select v-model="query.jobid" clearable placeholder="采集任务" class="handle-select mr10">
          <el-option v-for="(item,index) in jobs" :key="index" :label="item.jobName" :value="item.jobId"></el-option>

        </el-select>
        <template>
          <el-date-picker class="mr10" v-model="times" type="datetimerange" :picker-options="pickerOptions"
            range-separator="至" start-placeholder="采集时间" end-placeholder="采集时间" align="right">
          </el-date-picker>
        </template>
      ...
      <el-table :data="tableData" border class="table" ref="multipleTable" header-cell-class-name="table-header">
        <el-table-column prop="hospital" label="采集单位" align="center"></el-table-column>
        <el-table-column prop="username" label="采集人" width="100" align="center"></el-table-column>
        <el-table-column prop="name" label="采集任务" align="center"></el-table-column>
      ...
      <div class="pagination">
        <el-pagination :current-page="currentPage" :page-sizes="[2,20, 30, 50, 100]" :page-size="20" background layout="total, sizes, prev, pager, next"
