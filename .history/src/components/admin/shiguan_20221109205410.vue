    ...
    <div>
        ...
        <div class="container">
            <div class="handle-box">
                ...
                <template>
                    <el-date-picker class="mr10" v-model="times" type="datetimerange" :picker-options="pickerOptions"
                        range-separator="至" start-placeholder="采集时间" end-placeholder="采集时间" value-format="yyyy-MM-dd HH:mm:ss" align="right">
                    </el-date-picker>
                </template>
            ...
            <div class="pagination">
                <el-pagination :current-page="currentPage" :page-sizes="[20, 30, 50, 100]" :page-size="20" background
