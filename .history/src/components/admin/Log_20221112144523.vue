    ...
    <div>
        ...
        <div class="container">
            <div class="handle-box">
                <el-select v-model="this.tname" :disabled="groupdisable" clearable placeholder="表名" class="handle-select mr10">
                    <el-option v-for="(item, index) in tname1" :key="index" :label="item.tname" :value="item.tname"></el-option>
                </el-select>
