    ...
    <div>
        ...
        <div class="container">
            <div class="handle-box">
                <el-select v-model="tname.name" placeholder="表名" class="handle-select mr10" clearable>
                    <el-option v-for="(item, index) in tname1" :key="index" :label="item.name" :value="item.name"></el-option>
                </el-select>
                <el-input v-model="operation" placeholder="操作" class="handle-input mr10" clearable></el-input>
                <template>
            ...
            <el-table :data="tableData" height="250" border style="width: 100%">
                ...
                <el-table-column prop="operation" label="操作内容" width="180" align="center"> </el-table-column>
                ...
                <el-table-column fixed="right" label="" width="120" align="center">
                    <template slot-scope="scope">
                        <el-button @click.native.prevent="deleteRow(scope.$index, tableData.id)" type="text" size="small">
                            移除
                        </el-button>
                    </template>
                </el-table-column>
            ...
            <div class="pagination">
                <el-pagination :current-page="currentPage" :page-sizes="[5, 10, 50, 100]" :page-size="5" background
        ...
        methods: {
            getData() {
                this.$axios.post('/log/select', {
                    ...
                    if (res.data.code == 1) {
                        this.tableData = res.data.data.t;
